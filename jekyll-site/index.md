...
<div class="profile-hero">
  ...
  <h1 class="profile-name">Jorge A. de la Flor</h1>
  <p class="profile-title">Software Architect & Systems Developer</p>
  ...
  <div class="tech-badges">
    ...
    <span class="tech-badge" style="border-color: #f59e0b; color: #f59e0b;"><i class="fas fa-fingerprint"></i> Protocolos</span>
  </div>
...
<div style="font-size: 1.05rem; line-height: 1.8; color: var(--text-secondary);">
  <p><strong>Arquitecto de software y desarrollador de sistemas</strong> especializado en infraestructura cloud-agnóstica, sistemas embebidos y tooling de lenguajes. Creador de <strong>Apider</strong>, <strong>OMNI-PY</strong> e <strong>InvisibleDots</strong> — plataformas y protocolos que resuelven problemas de portabilidad, automatización, generación de código y autenticación de documentos físicos.</p>
...
<div class="card-grid">
  ...
  <div class="card">
    ...
    <p class="card-desc">
      ...
      inferencia de tipos y análisis de nulabilidad. Emisión idiomática y segura.
    </p>
  </div>
  
  <div class="card">
    <h3 class="card-title"><i class="fas fa-fingerprint" style="color: #f59e0b;"></i> InvisibleDots</h3>
    <p class="card-desc">
      Implementación de referencia del <strong>Protocolo IMEP</strong> (Invisible Metadata Encoding Protocol) 
      para incrustar metadatos criptográficamente verificables en documentos impresos. 
      <strong>Python + Rust</strong> con PyO3, Reed-Solomon, Ed25519 y OpenCV.
    </p>
    <a href="https://github.com/Jorge-de-la-Flor/InvisibleDots" class="card-link" target="_blank">Ver en GitHub →</a>
  </div>
</div>
...
<div style="background: var(--bg-card); border-left: 4px solid var(--accent-rust); padding: 1.5rem; border-radius: var(--radius); margin: 1.5rem 0;">
  ...
  <p style="color: var(--text-secondary); margin-bottom: 0;">
    Formaliza el principio de <strong>"Agnosticismo por Transformación"</strong> como principio arquitectónico unificado, aplicado en tres dominios: <strong>cloud</strong> (Apider), <strong>language tooling</strong> (OMNI-PY) y <strong>protocolos</strong> (IMEP/InvisibleDots).
  </p>
</div>
...
<div class="tech-badges" style="margin-bottom: 1.5rem; gap: 0.5rem;">
  <span class="tech-badge rust"><i class="fas fa-cog"></i> Rust</span>
  <span class="tech-badge python"><i class="fab fa-python"></i> Python</span>
  <span class="tech-badge cpp"><i class="fas fa-microchip"></i> C/C++</span>
  <span class="tech-badge embedded"><i class="fas fa-microchip"></i> ESP32/STM32</span>
  <span class="tech-badge ml"><i class="fas fa-code-branch"></i> Language Engineering</span>
  ...
  <span class="tech-badge" style="border-color: #34d399; color: #34d399;"><i class="fas fa-print"></i> IMEP</span>
</div>

**Además:** AST, MCP, Polars, PostgreSQL, SQLite, Docker, CI/CD, RTOS, protocolos embebidos (UART, SPI, I²C, MQTT), OpenCV, Reed-Solomon, Ed25519.

---

## ¿Colaboramos?

Busco oportunidades de **investigación** en arquitectura agnóstica, ingeniería de lenguajes, y sistemas embebidos de bajo nivel. Si tu proyecto necesita un enfoque arquitectónico sólido desde el inicio, hablemos.

<a href="mailto:{{ site.author.email }}" class="cta-button">Contactar</a>
